...
import com.jxx.groupware.batch.job.leave.config.QuartzVacationEndEventJob;
import com.jxx.groupware.batch.job.vacation.status.config.QuartzVacationStartEventJob;
import org.quartz.*;
